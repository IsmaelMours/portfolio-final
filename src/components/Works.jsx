        ...
        {live_demo_link && (
          <div className='mt-4 flex items-center'>
            <a href={live_demo_link} target='_blank' rel='noopener noreferrer'>
              <FiExternalLink className='text-[20px] text-white' />
            </a>
            <p className='ml-2 text-white text-[14px]'>Live Demo</p>
          </div>
        )}
      </Tilt>
    </motion.div>
...
// Export Works component wrapped with SectionWrapper
